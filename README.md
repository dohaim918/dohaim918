...
![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=dohaim918&background=00000000&border=922D6A&stroke=922D6A&ring=922D6A&fire=F776C4&currStreakLabel=922D6A&sideLabels=922D6A&dates=ffffff)

![](https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=dohaim918&theme=2077)
...
**Github** - **https://github.com/dohaim918** 
...
|-------|---------------------|
| **Illustrator / Photoshop / After Effects** | 기본 편집 및 작업을 문제없이 수행 |
| **HTML** | 간단한 마크업 가능 |
...
header-type
: wave, egg, shark, slice, soft, rounded

animation
: fadeIn, scaleIn, blink, blinking, twinkling
주요 파라미터
...
section : header 또는 footer
height : 숫자값 (기본: 120)
text : 표시할 텍스트 (URL 인코딩 필요, 공백은 %20)
fontColor : HEX 값 (# 없이): ffffff, d6ace6
fontSize : 숫자값 (기본: 70)
fontAlign : 0~100 (가로 위치, 기본: 50)
fontAlignY : 0~100 (세로 위치, 기본: 50)
animation : fadeIn, scaleIn, blink, blinking, twinkling
desc : 부제목 텍스트
descSize : 부제목 크기
descAlign / descAlignY : 부제목 위치
rotate : 텍스트 회전 각도 (-360 ~ 360)
stroke : 텍스트 테두리 색상
strokeWidth : 테두리 두께
reversal : true - 좌우 반전
-->
